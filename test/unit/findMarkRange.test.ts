...
describe("findMarkRange", () => {
  ...
  test("should find the range of a suggestion_add mark", async () => {
    ...
    // The range should start at position 5 (after "Hello")
    expect(range?.from).toBe(5);

    // The range should end at position 13 (after "awesome")
  ...
  test("should find the correct range for adjacent marks", async () => {
    ...
    // The range should end at position 23 (after "awesome fantastic")
